          ...
          <CardContent className="pt-7">
            ...
            <div className="mt-6 space-y-3 border-t border-slate-100 pt-5 text-sm dark:border-white/8">
              <Info
                icon={UserRound}
                label="Class"
                value={s.classes?.name ?? "Not assigned"}
              />
              <Info
                icon={Phone}
                label="Parent"
                value={`${s.parent_name} ? ${s.parent_phone}`}
              />
              <Info icon={MapPin} label="Address" value={s.address ?? "Not provided"} />
            </div>
          </CardContent>
        </Card>
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="truncate text-[11px] text-slate-500">
                          {p.receipt_number} | {p.academic_year} |{" "}
